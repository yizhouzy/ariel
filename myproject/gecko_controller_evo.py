...
def run_vision_simulation(model, 
    ...
    trajectory = []
    # Battery state: starts full (1.0) and drains linearly over the evaluation duration.
    battery = 1.0
    ...
    def fitness_function(x: Network) -> float:
        ...
        for target_pos in TARGET_POSITIONS:
            ...
            if battery_low:
                ...
                # Battery not low -> prioritize locomotion/exploration (longer path is better)
...
def main():
    ...
    target_body = world.spec.worldbody.add_body(name="charging_station", mocap=True, pos=target_pos)
