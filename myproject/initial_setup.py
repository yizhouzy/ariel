...
# --- REPLAY BEST & RECORD VIDEO ---
    ...
    # 1. Setup VideoRecorder (using Ariel library class)
    ...
    # Keep this outside the video loop so we don't recreate it every frame
    control_renderer = mujoco.Renderer(model, height=24, width=32)

    # 7. Main Rendering Loop (Using Context Manager as requested)
    # Use the video_recorder width/height for the output video
